...
let activePaginationPage = 2;
let maxPaginationPage = 23;

function setPagination(pageNum) {
  activePaginationPage = pageNum;
  var paginationHTML = ``;

  if (maxPaginationPage <= 7) {
    for (var i = 1; i <= maxPaginationPage; i++) {
      var partHTML =
    ...
    if (
      ...
      paginationHTML =
        ...
        '<button class="btn-page">1</button><span class="dots">...</span>';
      for (
        var i = activePaginationPage - 1;
        i <= activePaginationPage + 1;
        i++
      ) {
        var partHTML =
          '<button class="btn-page ' +
